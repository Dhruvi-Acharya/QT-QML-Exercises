...
typedef std::function <void()> DashboardMigrationHandler;

class DashboardDatabaseMigration
{
public:
    explicit DashboardDatabaseMigration(QSqlDatabase& database);
...
private:
    ...
    std::vector<DashboardMigrationHandler> m_migrationHandlers;
