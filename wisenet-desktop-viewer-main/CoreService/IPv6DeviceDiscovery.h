...
class IPv6DeviceDiscovery : public std::enable_shared_from_this<IPv6DeviceDiscovery>
{
public:
    IPv6DeviceDiscovery(asio::io_context& ioContext);
    ~IPv6DeviceDiscovery();

    void StartDiscoveryIPv6(DiscoverDevicesRequestSharedPtr const& request,
...
private:
    ...
    void discoverSunapiIPv6(DiscoverDevicesRequestSharedPtr const& request);
