...
Image{
    ...
    source: passwordRuleButtonMouseArea.containsMouse ? WisenetImage.info_normal : WisenetImage.info_disabled

    MouseArea{
        id: passwordRuleButtonMouseArea
    ...
    ToolTip{
        ...
        x: passwordRuleButtonMouseArea.x + 20
        y: passwordRuleButtonMouseArea.y + 2

        visible: passwordRuleButtonMouseArea.containsMouse
