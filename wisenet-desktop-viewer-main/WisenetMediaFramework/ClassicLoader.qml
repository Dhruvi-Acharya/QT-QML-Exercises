...
// https://github.com/Furkanzmc/QML-Loaders/blob/master/Loaders/SharinganLoader.qml
Item {

    // ----- Public Properties ----- //
    property color color: WisenetGui.contrast_01_light_grey
    ...
    property real _innerRadius: radius*0.7
