...
public:
    ...
    Q_INVOKABLE bool isChannelExist(const QString &deviceId, const QString &channelId);
...
private:
    ...
    QVariant getDataFromEventLogs(const QModelIndex &index, Role roleName) const;
    QVariant getDataBookmarkIdRole(const QModelIndex &index) const;
    QVariant getIsDeletedChannelRole(const QModelIndex &index) const;
    void clearData();
