...
class DeviceEventTreeSourceModel : public BaseTreeModel
{
    Q_OBJECT

public:
    explicit DeviceEventTreeSourceModel(QObject *parent = nullptr);
    virtual ~DeviceEventTreeSourceModel();


    Qt::ItemFlags flags(const QModelIndex &index) const Q_DECL_OVERRIDE;

    Q_INVOKABLE QModelIndex getModelIndex(QString guid);
    Q_INVOKABLE void readDevice();
