...
class DeviceEmailTreeSourceModel : public BaseTreeModel
{
    Q_OBJECT

public:
    explicit DeviceEmailTreeSourceModel(QObject *parent = nullptr);
    virtual ~DeviceEmailTreeSourceModel();
...
private:
    ...
    void addTreeEmailItem(QString groupName, QString groupEmail, QVector<QVariant> info);

    void addTreeEmailItem(QString uuid, QString groupName, QString userId, QString userEmail);
