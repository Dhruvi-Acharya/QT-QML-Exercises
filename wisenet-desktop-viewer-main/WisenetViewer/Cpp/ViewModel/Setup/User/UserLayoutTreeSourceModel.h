...
class UserLayoutTreeSourceModel : public BaseTreeModel
{
    Q_OBJECT

public:
    explicit UserLayoutTreeSourceModel(QObject *parent = nullptr);
    virtual ~UserLayoutTreeSourceModel();


    Qt::ItemFlags flags(const QModelIndex &index) const Q_DECL_OVERRIDE;

    Q_INVOKABLE QModelIndex getModelIndex(QString guid);
    Q_INVOKABLE void readLayouts( void );
...
private:
    ...
    void addTreeLayoutItem(const Wisenet::Core::Layout &layout);
