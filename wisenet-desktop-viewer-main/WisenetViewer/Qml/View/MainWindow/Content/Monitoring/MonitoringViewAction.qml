...
Item {
    ...
    */
    ...
    Action {
        shortcut: "Ctrl+S"
        onTriggered: saveActionTriggered();
    }
    // 다른 이름으로 저장
    Action {
        shortcut: Qt.platform.os === "windows" ? "F12" : "Ctrl+Shift+S"
        onTriggered: saveAsActionTriggered();
    }
    // 미디어 파일 열기
    Action {
        shortcut: "Ctrl+O"
    ...
    Action {
        ...
        onTriggered: newTabActionTriggered();
    }
    // 현재 탭 닫기
    Action {
        shortcut: "Ctrl+W"
        onTriggered: closeTabActionTriggered();
    }
}
