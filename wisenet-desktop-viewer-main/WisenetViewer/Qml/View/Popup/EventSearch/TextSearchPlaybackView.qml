...
Item {
    ...
    ViewingGrid {
        ...
        isFocusedWindow: textSearchPlayback.isFocusedWindow
        focus: true
        anchors.fill:parent
        ...
        onSmartSearchRequest: textSearchPlayback.smartSearchRequest()
        onFocusedItemChanged: focusedViewingGridItemChanged()
        onOpenMessageDialog: textSearchPlayback.openMessageDialog(message)
    }
    ...
    MediaControllerView {
        ...
        onSelectedTrackIdChanged: textSearchPlayback.selectedTrackIdChanged(trackId)
