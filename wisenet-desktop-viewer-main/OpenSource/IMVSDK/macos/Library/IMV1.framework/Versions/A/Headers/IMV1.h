...
public :
    ...
    enum
    {
        ...
        E_NAV_360x360_STABILIZED_LOCKED = 2,

        E_NAV_PAN_LOCKED = 4096,//mask to lock pan
        E_NAV_TILT_LOCKED = 8192, //mask to lock tilt
        E_NAV_ROLL_LOCKED = 16384, //mask to lock roll
        E_NAV_ROLL_ZOOMOUT_LOCKED = 32768,//always horizontal fixed
        E_NAV_ROLL_ZOOMOUT_FREE = 65536,//roll of the phone horizontal fixed
    } eNavigationType;
} ;
...
public :
    ...
    /* added by hh3.kim 2022-02-21 */
    unsigned long SetPrivateSTG(char* stg);
